...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    Intent intent;
    String DriverActTag = "In Driver Location";
                        ...
                        for (ParseObject object : objects) {
                            ...
                            object.saveInBackground(new SaveCallback() {
                                ...
                                public void done(ParseException e) {
                                    if (e == null) {
                                        Intent directionsIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://maps.google.com/maps?saddr=" + intent.getDoubleExtra("driverLatitude", 0) + "," + intent.getDoubleExtra("driverLongitude", 0)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Log.e(DriverActTag, requestLat + " " + requestlng);
